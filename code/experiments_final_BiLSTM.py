...
method_name = "BiLSTM"
cls_method = "BiLSTM_calibrated"
params_dir = "../parameter/BiLSTM/optimal_params_BiLSTM"
results_dir = "../parameter/BiLSTM/result_BiLSTM"
...
if n_layers == 1:
    lstm1 = LSTM(lstmsize, implementation=2, kernel_initializer='glorot_uniform',return_sequences=False, dropout=dropout)
    model.add(keras.layers.Bidirectional(lstm1,input_shape=(max_len, data_dim)))
    model.add(BatchNormalization())

elif n_layers == 2:
    model.add(keras.layers.Bidirectional(LSTM(lstmsize, implementation=2, kernel_initializer='glorot_uniform',
...
# history = model.fit(X, y, validation_data=(X_val, y_val), verbose=2, callbacks=[auc_cb], batch_size=batch_size, epochs=nb_epoch)
