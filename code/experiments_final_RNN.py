...
method_name = "RNN"
cls_method = "RNN_calibrated"

params_dir = "../parameter/RNN/optimal_params_rnn"
results_dir = "../parameter/RNN/result_rnn"
...
if n_layers == 1:
    l2_3 = SimpleRNN(lstmsize, input_shape=(max_len, data_dim), implementation=2, kernel_initializer='glorot_uniform',
                     return_sequences=False, dropout=dropout)(main_input)
    b2_3 = BatchNormalization()(l2_3)

elif n_layers == 2:
    l1 = SimpleRNN(lstmsize, input_shape=(max_len, data_dim), implementation=2, kernel_initializer='glorot_uniform',
                   return_sequences=True, dropout=dropout)(main_input)
    b1 = BatchNormalization(axis=1)(l1)
    l2_3 = SimpleRNN(lstmsize, implementation=2, kernel_initializer='glorot_uniform', return_sequences=False,
                     dropout=dropout)(b1)
    b2_3 = BatchNormalization()(l2_3)
    ...
    l1 = SimpleRNN(lstmsize, input_shape=(max_len, data_dim), implementation=2, kernel_initializer='glorot_uniform',
                   return_sequences=True, dropout=dropout)(main_input)
    b1 = BatchNormalization(axis=1)(l1)
    l2 = SimpleRNN(lstmsize, implementation=2, kernel_initializer='glorot_uniform', return_sequences=True,
                   dropout=dropout)(b1)
    b2 = BatchNormalization(axis=1)(l2)
    l3 = SimpleRNN(lstmsize, implementation=2, kernel_initializer='glorot_uniform', return_sequences=False,
                   dropout=dropout)(b2)
...
def wrapped_partial(func, *args, **kwargs):
    ...
    return partial_func
ncce = wrapped_partial(WeightedBinaryCrossEntropy, weights=0.01)
...
model.compile(loss={'outcome_output':ncce}, optimizer=opt)
